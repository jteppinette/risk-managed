...
from risk_managed.forms import FlagForm
from risk_managed.models import Flag, Guest
...
def list(request):
    ...
    return render(
        request, "flags/list.html", {"host_flags": host_flags, "admin_flags": admin_flags}
    )
...
def new(request, guest):
    ...
    return render(request, "flags/new.html", {"form": form})
