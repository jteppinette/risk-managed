...
def detail(request, event):
    ...
    return render(request, "main/events/detail.html", {"event": event, "guestimages": guestimages})
...
def new(request):
    if request.method == "POST":
        ...
        form = EventForm()
    return render(request, "main/events/new.html", {"form": form})
...
def checkin(request, event):
    ...
    return render(request, "main/events/checkin.html", {"form": form, "event": event})
